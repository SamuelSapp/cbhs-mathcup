ExitDialogue = Class{
  ...
  draw = function(self)
    ...
    love.graphics.printf("Yes", self.width*4/3, self.height*6/2, self.width, "center", 0, 1, 1, 0, love.graphics.getFont():getHeight()/2)
    love.graphics.printf("No", self.width*8/3, self.height*6/2, self.width, "center", 0, 1, 1, 0, love.graphics.getFont():getHeight()/2)
  end
}